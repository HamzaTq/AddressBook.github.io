...
// -------------------------------------------------- //
let addrName = firstName = lastName = email = phone = "";
var radio=0;

// Address class
class Address{
    constructor(id, addrName, firstName, lastName, email, phone){
        this.id = id;
    ...
    modalBtns.addEventListener('click', (event) => {
        ...
        if(event.target.id == "save-btn"){
            ...
            if(!isFormValid){
                ...
                const addressItem = new Address(lastItemId, addrName, firstName, lastName, email, phone);
    ...
    modalBtns.addEventListener('click', (event) => {
        ...
        if(event.target.id == "update-btn"){
            ...
            if(!isFormValid){
                ...
                const addressItem = new Address(id, addrName, firstName, lastName, email, phone);
